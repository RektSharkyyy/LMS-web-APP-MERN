    ...
    <footer className="bg-gray-900 md:px-36 text-center w-full mt-10 ">
      ...
      >
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <p className="mt-6 text-center md:text-left text-sm text-white/30">
            add anytype of discription its just bla bla bla
          </p>
        </div>
        <div className="flex flex-col md:items-start items-center w-full">
          <h2 className="font-semibold text-white mb-5">Company</h2>
          <ul
            className="flex md:flex-col w-full justify-between text-sm text-white/80
            md:space-y-2"
          >
            <li>
              <a href="#">Home</a>
        ...
        <div className="hidden md:flex flex-col items-start w-full">
          ...
          <p className="text-sm text-white/80">
            The latest news, articles, and rsources, sent to your inbox weekly
          </p>
          <div className="flex flex-center gap-2 pt-4">
            <input
              type="email"
      ...
      <p className="py-4 text-center text-xs text-white/60">
        Copyright 2025 © OvizAcademy. All right Reserved.
      </p>
    </footer>
  );
};
