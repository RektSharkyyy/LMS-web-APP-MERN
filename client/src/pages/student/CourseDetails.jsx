...
const CourseDetails = () => {
  ...
  justify-between md:px-36 px-8 md:pt-30 pt-20 text-left"
    ...
    from-cyan-100/70"
        ...
        {/* right column */}
        <div
          className="max-w-course-card z-10 shadow-custome-card rounded-t md:rounded-none
        overflow-hidden bg-white min-w-[300px] sm:min-[420px]"
        >
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            rounded bg-blue-600 text-white font-medium"
            >
              {isAlreadyEnrolled ? "Already Enrolled" : "Enroll now"}
            </button>
            <div className="pt-6">
              <p className="md:text-1 text-lg font-medium text-gray-800">
